...
export const mutationManager = {
    /** @type {Set<(addedNodes: [Node])=>{}>} */
    onAddedNodes: new Set(),

    /** @type {Set<(removedNodes: [Node])=>{}>} */
   ...
   * @param {()=>{}} callback no params will be passed
   */
    removeDisplayListener(element, callback) {
        displayListeners.delete(element, callback)
    },
   ...
   * @param {()=>{}} callback no params will be passed
   */
    removeCloseListener(element, callback) {
        removeListeners.delete(element, callback)
    },
}
