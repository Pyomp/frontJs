...
/** 
 * @typedef {import('./managers/Asset.js').Asset} Asset
 * @typedef {import('./managers/DisablesManager.js').DisablesManager} DisablesManager
 * @typedef {import('./managers/InitManager.js').InitManager} InitManager
 * @typedef {import('./managers/WorkerManager.js').WorkerManager} WorkerManager
*/
