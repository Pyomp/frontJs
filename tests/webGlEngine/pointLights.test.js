...
export default function pointLightsTest() {
    ...
    const pointLightsMock = renderer.lights.pointLights = test.mock(renderer.lights.pointLights)
    ...
    test.test(
        ...
        () => {
            ...
            const info1 = renderer.lights.pointLights.getInfo()
            if (info1.currentLights[0] === pointLight1) {
                return test.fail(renderer.lights.pointLights)
            }

            test.time.nextTick(10, 20)

            const info2 = renderer.lights.pointLights.getInfo()
    ...
    test.test(
        ...
        () => {
            ...
            const info = renderer.lights.pointLights.getInfo()
