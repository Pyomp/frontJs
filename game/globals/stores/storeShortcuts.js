...
export const storeShortcuts = {
    ...
    [ACTION_1]: new Shortcut({ action: ACTION_1, button: 0 }),
    [ACTION_2]: new Shortcut({ action: ACTION_2, button: 2 }),
    [ACTION_3]: new Shortcut({ action: ACTION_3, button: 1 }),
    [ACTION_4]: new Shortcut({ action: ACTION_4, code: 'KeyQ' }),
    [ACTION_5]: new Shortcut({ action: ACTION_5, code: 'KeyE' }),
    [ACTION_6]: new Shortcut({ action: ACTION_6, code: 'KeyR' }),
    [ACTION_7]: new Shortcut({ action: ACTION_7, code: 'KeyT' }),
    [ACTION_8]: new Shortcut({ action: ACTION_8, code: 'KeyG' }),
